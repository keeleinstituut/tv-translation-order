...
/**
 * @mixin InstitutionPrice
 */
#[OA\Schema(
    title: 'InstitutionPrice',
    required: [
        'id', 'institution_id', 'skill_id', 'src_lang_classifier_value_id', 'dst_lang_classifier_value_id',
    ...
    properties: [
        ...
        new OA\Property(property: 'institution', ref: InstitutionResource::class, type: 'object'),
...
class InstitutionPriceResource extends JsonResource
{
