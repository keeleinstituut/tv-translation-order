...
class TaskResource2 extends JsonResource
{
    /**
    ...
    {
        return [
            'id' => data_get($this, 'task_id'),
            'assignee_institution_user_id' => data_get($this, 'task_assignee'),
            'task_type' => data_get($this, 'var_task_type'),
            'project_id' => data_get($this, 'var_project_id'),
